---
title: "Interac Sentiment StarWar"
author: "Owen Ouyang"
date: '`r Sys.Date()`'
output:
  html_document:
...
# LUKE Different Emotions Wordcloud
******
...
plot(network,                
  ...
  # Character vector used to label the nodes
    ...
    layout=layout.circle, main="Star Wars Relationship Network")                       # The position of the label in relation to the vertex (use pi)ze2=NA)                               # The second size of the node (e.g. for a rectangle)
